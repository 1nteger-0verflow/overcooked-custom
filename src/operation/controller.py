...
class Controller:
    def __init__(self, env, config: list[dict[str, Any]], verbose: bool, confirm: bool):
        # エージェントが何体いるか、
        ...
        for i in range(self.num_agents):
            self.controllers.append(AgentController.create_controller(config[i], i, num_actions, verbose, confirm))
